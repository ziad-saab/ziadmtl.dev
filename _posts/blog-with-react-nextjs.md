---
title: Let's make a WordPress-based blog with React and Next.js
description: In this tutorial, we'll be creating a blog with React and Next.js. For content management, the blog will be backed by WordPress.
cover: /blog-images/blog-with-react-nextjs/retrosupply-jLwVAUtLOAQ-unsplash.jpg
date: "2019-01-16"
---
...
## Introduction
In this tutorial, we are going to make a blog. To manage the content of our blog, we will be using
WordPress. However, contrary to most WordPress
blogs in existence today, we will not be using PHP to create the theme for our blog. Instead, we are
going to manage the front-end with a variety of modern web technologies: JavaScript, React with Next.js, and some
NodeJS.
...
* :fire: Pros:
    * Next.js gives us server rendering for free. This will make our blog load super quickly, and allow indexing by search engines.
...
<div class="flex">
    <img style="height: 200px" src="https://media0.giphy.com/media/wiAp4dCDPfm7u/giphy.gif">
    <div class="flex-1">
...
* [Install NVM](https://github.com/creationix/nvm)
  ...
  tutorial, we will be using **NodeJS 8.9.0**. Once NVM is installed, you can run the following
...
* [Install the WebStorm IDE](https://www.jetbrains.com/webstorm/)
  ...
  **NOTE**: It is fine to use the IDE of your choice, but WebStorm is being used during the tutorial.
...
* **What about WordPress??** :question:
  ...
  You will not need to install a WordPress instance in order to complete the tutorial. If you
...
Based on the requirements of this tutorial, this should all be familiar to you except perhaps for
the Next.js framework. [Next.js](https://github.com/zeit/next.js/) is the framework that will allow
...
This concludes the initial setup of the tutorial. Let's seal the deal by
...
:warning: **NOTE**: from now on, the tutorial instructions will not mention Git anymore. It's up to
you if you want to use it to have a clean commit for each step of the tutorial. If you do, it will
...
Later in the tutorial, we will leverage this data to display our pages.
...
Explaining CORS is beyond the scope of this tutorial, but feel free to follow the links to learn
...
If you are using WebStorm to do this tutorial, you might have noticed something weird: there is no
...
doable. It is beyond the scope of this tutorial.
...
## Make it your own!
If you finished this tutorial, here are some things you can work on to make it your own:
